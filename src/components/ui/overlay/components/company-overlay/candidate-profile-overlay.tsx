                        ...
                        <div className="title-overlay flex justify-between items-center">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    ...
                                    className="h-[48px]"
                                    onClick={() => {
                                        const email = candidateDetail.email; // Địa chỉ email từ candidateDetail
                                        window.location.href = `mailto:${email}`; // Mở ứng dụng email với địa chỉ đã điền
                                    }}
                                >
                                    Send Mail
                                </Button>
                            ...
                            <div className="main-right w-[312px] flex flex-col gap-6">
                                ...
                                <div className="main-right-bottom flex flex-col p-6 border-2 rounded-lg gap-6">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <Button variant={"ghost"}
                                            onClick={() => handleDownload("https://res.cloudinary.com/dhsv9jnul/image/upload/v1735101443/my_job/fcp8za1piwpzjvi0vxme.jpg")}
                                        >
