    ...
    <div className=" w-[360px] border rounded-lg px-[32px] py-[24px] ">
      <div className="flex flex-col gap-3  pb-[20px] pt-[20px] border-b-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          />
          <BoxFilter
            props={{ id: "2", name: "experiences", value: "1 - 2 year", title: "1 - 2 years" }}
            selectedValue={filters.experiences}
            onChange={onFilterChange}
          />
          <BoxFilter
            props={{ id: "3", name: "experiences", value: "2 - 3 year", title: "2 - 3 years" }}
            selectedValue={filters.experiences}
            onChange={onFilterChange}
          />
          <BoxFilter
            props={{ id: "4", name: "experiences", value: "~ 5 year", title: "~ 5 years" }}
            selectedValue={filters.experiences}
            onChange={onFilterChange}
          />
        </div>
